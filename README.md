...
| 06_transaction.sql| Esta transacción se encarga de sumar XP al usuario y registra o actualiza una recompensa obtenida, si ambos son exitosos entonces se confirma el commit y de lo contrario se revierte con un rollback. |
